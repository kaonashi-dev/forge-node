import { dialogsStore, setDialogsStore, type ConfirmRequest } from "../../../state/dialogs";
import { AlertDialog, Button } from "../../../ui/index";

/**
 * The one confirmation the shell asks any destructive question through.
 *
 * Mounted once by `AppShell` and driven from `dialogsStore.confirm`, so a call
...
export function ConfirmDialog(props: { request: ConfirmRequest }) {
  ...
  return (
    <AlertDialog
      ...
      size="sm"
      open={dialogsStore.confirm !== null}
      onDismiss={dismiss}
      footer={
        <>
