...
import { WorkMarker } from "../features/sessions/markers";
import { applyThemeBase, themeBase } from "../theme/ThemeProvider";
import { palettes, THEME_LABELS, type ThemeBaseId } from "../theme/tokens";
...
function Primitives() {
  ...
  return (
    <>
      ...
      {/* Controls share one gallery page
