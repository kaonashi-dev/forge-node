...
import { filterTree, treeRows } from "../workbench/filetree";
import { installTreeFollow } from "../workbench/treeFollow";
import type { FileTree } from "../workbench/types";
import { activeEditorPath, type WorkbenchView } from "../workbench/views";
