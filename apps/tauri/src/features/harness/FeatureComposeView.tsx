...
import { featureIsOpen, featureLabel } from "../../contracts/harness";
import { forgeStore } from "../../state/forgeStore";
import { harnessStore, openFeature, setHarnessStore } from "./harnessStore";
...
import { FEATURE_COMPOSE_VIEW } from "../../navigation/views";
 ...
 * pointing at nothing, which is worse than a box that does not take images.
 */
