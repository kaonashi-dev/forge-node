...
import { AlertDialog, Badge, Button, Menu, Select, Switch, TextField } from "../../ui/index";
import { Icon } from "../../theme/icons/index";
import { Group, Page, Row } from "../settings/SettingsLayout";
import { forgeStore } from "../../state/forgeStore";
import { sharesStore } from "./sharesStore";
import { pickFile } from "../../runtime/host";
import { removeShareRule, setProjectShares } from "./commands";
import type {
  ShareCandidate,
  ShareCleanup,
  ShareRule,
...
export function SharedFiles(props: { projectId?: string; workspaceId?: string } = {}) {
  const workspaceId = () => props.workspaceId ?? (props.projectId ? null : activeWorkspace());
